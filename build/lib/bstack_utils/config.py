...
conf = {
    bstack11ll_opy_ (u"ࠧࡢࡲࡳࡣࡦࡻࡴࡰ࡯ࡤࡸࡪ࠭ᛀ"): False,
    bstack11ll_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫ࡠࡵࡨࡷࡸ࡯࡯࡯ࠩᛁ"): True,
    bstack11ll_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᛂ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack11111ll1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll11ll1ll_opy_=None):
        return self._11ll11ll1l1_opy_.get(property_name, bstack11ll11ll1ll_opy_)
    def set_property(self, property_name, bstack11ll11lll11_opy_):
        self._11ll11ll1l1_opy_[property_name] = bstack11ll11lll11_opy_
    def bstack1lllll1lll_opy_(self, val):
        self._11ll11ll1l1_opy_[bstack11ll_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᛃ")] = bool(val)
    def bstack111111ll_opy_(self):
        return self._11ll11ll1l1_opy_.get(bstack11ll_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪᛄ"), False)