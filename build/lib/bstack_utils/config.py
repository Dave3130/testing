...
conf = {
    bstack11111_opy_ (u"ࠪࡥࡵࡶ࡟ࡢࡷࡷࡳࡲࡧࡴࡦࠩᚋ"): False,
    bstack11111_opy_ (u"ࠫࡧࡹࡴࡢࡥ࡮ࡣࡸ࡫ࡳࡴ࡫ࡲࡲࠬᚌ"): True,
    bstack11111_opy_ (u"ࠬࡹ࡫ࡪࡲࡢࡷࡪࡹࡳࡪࡱࡱࡣࡸࡺࡡࡵࡷࡶࠫᚍ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    def bstack111111ll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1l111ll_opy_=None):
        return self._11ll1l11l1l_opy_.get(property_name, bstack11ll1l111ll_opy_)
    def set_property(self, property_name, bstack11ll1l11l11_opy_):
        self._11ll1l11l1l_opy_[property_name] = bstack11ll1l11l11_opy_
    def bstack1ll11l11ll_opy_(self, val):
        self._11ll1l11l1l_opy_[bstack11111_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬᚎ")] = bool(val)
    def bstack1lll1lll1_opy_(self):
        return self._11ll1l11l1l_opy_.get(bstack11111_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᚏ"), False)