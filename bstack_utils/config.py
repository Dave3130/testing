...
conf = {
    bstack11l11ll_opy_ (u"ࠫࡦࡶࡰࡠࡣࡸࡸࡴࡳࡡࡵࡧࠪᛋ"): False,
    bstack11l11ll_opy_ (u"ࠬࡨࡳࡵࡣࡦ࡯ࡤࡹࡥࡴࡵ࡬ࡳࡳ࠭ᛌ"): True,
    bstack11l11ll_opy_ (u"࠭ࡳ࡬࡫ࡳࡣࡸ࡫ࡳࡴ࡫ࡲࡲࡤࡹࡴࡢࡶࡸࡷࠬᛍ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll11ll11l_opy_ = conf
    @classmethod
    def bstack1llll111l_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll11l1lll_opy_=None):
        return self._11ll11ll11l_opy_.get(property_name, bstack11ll11l1lll_opy_)
    def set_property(self, property_name, bstack11ll11ll111_opy_):
        self._11ll11ll11l_opy_[property_name] = bstack11ll11ll111_opy_
    def bstack11l11ll11l_opy_(self, val):
        self._11ll11ll11l_opy_[bstack11l11ll_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᛎ")] = bool(val)
    def bstack1lllllll1_opy_(self):
        return self._11ll11ll11l_opy_.get(bstack11l11ll_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᛏ"), False)