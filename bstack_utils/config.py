...
conf = {
    bstack1ll11_opy_ (u"ࠬࡧࡰࡱࡡࡤࡹࡹࡵ࡭ࡢࡶࡨࠫ᚛"): False,
    bstack1ll11_opy_ (u"࠭ࡢࡴࡶࡤࡧࡰࡥࡳࡦࡵࡶ࡭ࡴࡴࠧ᚜"): True,
    bstack1ll11_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭᚝"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll1l11ll1_opy_ = conf
    @classmethod
    def bstack1llll11l1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1l11lll_opy_=None):
        return self._11ll1l11ll1_opy_.get(property_name, bstack11ll1l11lll_opy_)
    def set_property(self, property_name, bstack11ll1l1l111_opy_):
        self._11ll1l11ll1_opy_[property_name] = bstack11ll1l1l111_opy_
    def bstack1l111ll1l_opy_(self, val):
        self._11ll1l11ll1_opy_[bstack1ll11_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧ᚞")] = bool(val)
    def bstack1111l11l_opy_(self):
        return self._11ll1l11ll1_opy_.get(bstack1ll11_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨ᚟"), False)