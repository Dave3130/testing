...
conf = {
    bstack11l1l11_opy_ (u"ࠬࡧࡰࡱࡡࡤࡹࡹࡵ࡭ࡢࡶࡨࠫᚔ"): False,
    bstack11l1l11_opy_ (u"࠭ࡢࡴࡶࡤࡧࡰࡥࡳࡦࡵࡶ࡭ࡴࡴࠧᚕ"): True,
    bstack11l1l11_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᚖ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack1111lll1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll1l11l11_opy_=None):
        return self._11ll1l11l1l_opy_.get(property_name, bstack11ll1l11l11_opy_)
    def set_property(self, property_name, bstack11ll1l11ll1_opy_):
        self._11ll1l11l1l_opy_[property_name] = bstack11ll1l11ll1_opy_
    def bstack1l111l1111_opy_(self, val):
        self._11ll1l11l1l_opy_[bstack11l1l11_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᚗ")] = bool(val)
    def bstack11l11ll1_opy_(self):
        return self._11ll1l11l1l_opy_.get(bstack11l1l11_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᚘ"), False)