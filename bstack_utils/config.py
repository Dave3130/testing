...
conf = {
    bstack11111_opy_ (u"ࠬࡧࡰࡱࡡࡤࡹࡹࡵ࡭ࡢࡶࡨࠫᛚ"): False,
    bstack11111_opy_ (u"࠭ࡢࡴࡶࡤࡧࡰࡥࡳࡦࡵࡶ࡭ࡴࡴࠧᛛ"): True,
    bstack11111_opy_ (u"ࠧࡴ࡭࡬ࡴࡤࡹࡥࡴࡵ࡬ࡳࡳࡥࡳࡵࡣࡷࡹࡸ࠭ᛜ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll11l1l11_opy_ = conf
    @classmethod
    def bstack1111llll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll11l11l1_opy_=None):
        return self._11ll11l1l11_opy_.get(property_name, bstack11ll11l11l1_opy_)
    def set_property(self, property_name, bstack11ll11l11ll_opy_):
        self._11ll11l1l11_opy_[property_name] = bstack11ll11l11ll_opy_
    def bstack111l11lll_opy_(self, val):
        self._11ll11l1l11_opy_[bstack11111_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᛝ")] = bool(val)
    def bstack1111l11l_opy_(self):
        return self._11ll11l1l11_opy_.get(bstack11111_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᛞ"), False)