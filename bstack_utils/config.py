...
conf = {
    bstack111l1l_opy_ (u"ࠧࡢࡲࡳࡣࡦࡻࡴࡰ࡯ࡤࡸࡪ࠭ᚹ"): False,
    bstack111l1l_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫ࡠࡵࡨࡷࡸ࡯࡯࡯ࠩᚺ"): True,
    bstack111l1l_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᚻ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    @classmethod
    def bstack1111ll1l_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll11ll1l1_opy_=None):
        return self._11ll11ll11l_opy_.get(property_name, bstack11ll11ll1l1_opy_)
    def set_property(self, property_name, bstack11ll11ll1ll_opy_):
        self._11ll11ll11l_opy_[property_name] = bstack11ll11ll1ll_opy_
    def bstack111lll1l11_opy_(self, val):
        self._11ll11ll11l_opy_[bstack111l1l_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᚼ")] = bool(val)
    def bstack1llll1ll1_opy_(self):
        return self._11ll11ll11l_opy_.get(bstack111l1l_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪᚽ"), False)