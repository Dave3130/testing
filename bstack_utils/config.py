...
conf = {
    bstack11ll1ll_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬᛛ"): False,
    bstack11ll1ll_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨᛜ"): True,
    bstack11ll1ll_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧᛝ"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11ll11l11ll_opy_ = conf
    @classmethod
    def bstack1lll11ll1_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11ll11l11l1_opy_=None):
        return self._11ll11l11ll_opy_.get(property_name, bstack11ll11l11l1_opy_)
    def set_property(self, property_name, bstack11ll11l1l11_opy_):
        self._11ll11l11ll_opy_[property_name] = bstack11ll11l1l11_opy_
    def bstack1l1l1l111_opy_(self, val):
        self._11ll11l11ll_opy_[bstack11ll1ll_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᛞ")] = bool(val)
    def bstack111111l1_opy_(self):
        return self._11ll11l11ll_opy_.get(bstack11ll1ll_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᛟ"), False)