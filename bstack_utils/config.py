...
conf = {
    bstack1ll1l_opy_ (u"ࠧࡢࡲࡳࡣࡦࡻࡴࡰ࡯ࡤࡸࡪ࠭ᚖ"): False,
    bstack1ll1l_opy_ (u"ࠨࡤࡶࡸࡦࡩ࡫ࡠࡵࡨࡷࡸ࡯࡯࡯ࠩᚗ"): True,
    bstack1ll1l_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨᚘ"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    def bstack1llllll1l1_opy_(self, val):
        self._11ll1l11l1l_opy_[bstack1ll1l_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩᚙ")] = bool(val)
    def bstack1lll1l1ll_opy_(self):
        return self._11ll1l11l1l_opy_.get(bstack1ll1l_opy_ (u"ࠫࡸࡱࡩࡱࡡࡶࡩࡸࡹࡩࡰࡰࡢࡷࡹࡧࡴࡶࡵࠪᚚ"), False)