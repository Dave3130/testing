...
bstack111ll11111l_opy_ = 2
class bstack111l1llll1l_opy_:
    def __init__(self, handler, bstack111l1llll11_opy_=bstack111ll111111_opy_, bstack111l1llllll_opy_=bstack111ll11111l_opy_):
        self.queue = []
    ...
    def bstack111l1lll1ll_opy_(self):
        try:
            ...
            logger.debug(bstack11l1l11_opy_ (u"ࠬࡡࡳࡵࡱࡳࡣࡹ࡯࡭ࡦࡴࡠࠤࡊࡾࡣࡦࡲࡷ࡭ࡴࡴ࠺ࠡࠩᯢ") + (str(e) or bstack11l1l11_opy_ (u"ࠨࡅࡹࡥࡨࡴࡹ࡯࡯࡯ࠢࡦࡳࡺࡲࡤࠡࡰࡲࡸࠥࡨࡥࠡࡥࡲࡲࡻ࡫ࡲࡵࡧࡧࠤࡹࡵࠠࡴࡶࡵ࡭ࡳ࡭ࠢᯣ")))
        finally:
            self.timer = None
    ...
    def add(self, event):
        with self.lock:
            ...
            if len(self.queue) >= self.bstack111l1llll11_opy_:
                threading.Thread(target=self.bstack111ll1111l1_opy_).start()
    def bstack111ll1111l1_opy_(self, source = bstack11l1l11_opy_ (u"ࠧࠨᯤ")):
        with self.lock:
            if not self.queue:
        ...
        self.handler(data)
        if source != bstack11l1l11_opy_ (u"ࠨࡵ࡫ࡹࡹࡪ࡯ࡸࡰࠪᯥ"):
            self.bstack111l1lll1l1_opy_()
    def shutdown(self):
        self.bstack111l1lll1ll_opy_()
        while self.queue:
            self.bstack111ll1111l1_opy_(source=bstack11l1l11_opy_ (u"ࠩࡶ࡬ࡺࡺࡤࡰࡹࡱ᯦ࠫ"))