...
class bstack111ll1l1111_opy_:
    def __init__(self, handler, bstack111ll11l111_opy_=bstack111ll11l1l1_opy_, bstack111ll11l11l_opy_=bstack111ll11l1ll_opy_):
        self.queue = []
    ...
    def bstack111ll111lll_opy_(self):
        ...
        def bstack111ll11ll1l_opy_():
            self.bstack1l1ll1llll1_opy_.wait(self.bstack111ll11l11l_opy_)
    ...
    def bstack111ll11ll11_opy_(self):
        try:
            ...
            logger.debug(bstack1lllll1_opy_ (u"ࠬࡡࡳࡵࡱࡳࡣࡹ࡯࡭ࡦࡴࡠࠤࡊࡾࡣࡦࡲࡷ࡭ࡴࡴ࠺ࠡࠩᯆ") + (str(e) or bstack1lllll1_opy_ (u"ࠨࡅࡹࡥࡨࡴࡹ࡯࡯࡯ࠢࡦࡳࡺࡲࡤࠡࡰࡲࡸࠥࡨࡥࠡࡥࡲࡲࡻ࡫ࡲࡵࡧࡧࠤࡹࡵࠠࡴࡶࡵ࡭ࡳ࡭ࠢᯇ")))
        finally:
            self.timer = None
    ...
    def bstack111ll11lll1_opy_(self, source = bstack1lllll1_opy_ (u"ࠧࠨᯈ")):
        with self.lock:
            if not self.queue:
        ...
        self.handler(data)
        if source != bstack1lllll1_opy_ (u"ࠨࡵ࡫ࡹࡹࡪ࡯ࡸࡰࠪᯉ"):
            self.bstack111ll11llll_opy_()
    def shutdown(self):
        self.bstack111ll11ll11_opy_()
        while self.queue:
            self.bstack111ll11lll1_opy_(source=bstack1lllll1_opy_ (u"ࠩࡶ࡬ࡺࡺࡤࡰࡹࡱࠫᯊ"))