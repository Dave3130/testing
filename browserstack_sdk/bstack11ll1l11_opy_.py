    ...
    try:
        ...
        if bstack11l1ll11_opy_ is not None:
            ...
            if isinstance(bstack11ll11l1_opy_, str):
                ...
                args = [bstack11l111_opy_ (u"ࠤ࠱ࠦे")]
        else:
            args = [bstack11l111_opy_ (u"ࠥ࠲ࠧै")]
        bstack11ll11ll_opy_ = args + [
            bstack11l111_opy_ (u"ࠦ࠲࠳ࡣࡰ࡮࡯ࡩࡨࡺ࠭ࡰࡰ࡯ࡽࠧॉ"),
        ]
        if bstack11l1l1ll_opy_:
            bstack11ll11ll_opy_.append(bstack11l111_opy_ (u"ࠧ࠳ࡱࠣॊ"))
        class bstack11ll1ll1_opy_:
            bstack11l111_opy_ (u"ࠨࠢࠣࡒࡼࡸࡪࡹࡴࠡࡲ࡯ࡹ࡬࡯࡮ࠡࡶ࡫ࡥࡹࠦࡣࡢࡲࡷࡹࡷ࡫ࡳࠡࡥࡲࡰࡱ࡫ࡣࡵࡧࡧࠤࡹ࡫ࡳࡵࠢ࡬ࡸࡪࡳࡳ࠯ࠤࠥࠦो")
            def __init__(self):
                self.bstack11ll1111_opy_ = []
                self.test_files = set()
                self.bstack11ll1l1l_opy_ = None
            def pytest_collection_finish(self, session):
                bstack11l111_opy_ (u"ࠢࠣࠤࠍࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࡎ࡯ࡰ࡭ࠣࡧࡦࡲ࡬ࡦࡦࠣࡥ࡫ࡺࡥࡳࠢࡦࡳࡱࡲࡥࡤࡶ࡬ࡳࡳࠦࡩࡴࠢࡩ࡭ࡳ࡯ࡳࡩࡧࡧ࠲ࠏࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࡄࡣࡳࡸࡺࡸࡥࡴࠢࡤࡰࡱࠦࡣࡰ࡮࡯ࡩࡨࡺࡥࡥࠢࡷࡩࡸࡺࠠࡪࡶࡨࡱࡸ࠴ࠊࠡࠢࠣࠤࠥࠦࠠࠡࠢࠣࠤࠥࠦࠠࠡࠢࠥࠦࠧौ")
                try:
                    for item in session.items:
                        nodeid = item.nodeid
                        self.bstack11ll1111_opy_.append(nodeid)
                        if bstack11l111_opy_ (u"ࠣ࠼࠽्ࠦ") in nodeid:
                            file_path = nodeid.split(bstack11l111_opy_ (u"ࠤ࠽࠾ࠧॎ"), 1)[0]
                            file_path = os.path.normpath(file_path).replace(bstack11l111_opy_ (u"ࠪࡠࡡ࠭ॏ"), bstack11l111_opy_ (u"ࠫ࠴࠭ॐ"))
                            if file_path.endswith(bstack11l111_opy_ (u"ࠬ࠴ࡰࡺࠩ॑")):
                                self.test_files.add(file_path)
                except Exception as e:
                    self.bstack11ll1l1l_opy_ = str(e)
        ...
        if bstack11l1l1ll_opy_:
            ...
            exit_code = pytest.main(bstack11ll11ll_opy_, plugins=[collector])
        if collector.bstack11ll1l1l_opy_:
            return {
                bstack11l111_opy_ (u"ࠨࡳࡶࡥࡦࡩࡸࡹ॒ࠢ"): False,
                bstack11l111_opy_ (u"ࠢࡤࡱࡸࡲࡹࠨ॓"): 0,
                bstack11l111_opy_ (u"ࠣࡰࡲࡨࡪ࡯ࡤࡴࠤ॔"): [],
                bstack11l111_opy_ (u"ࠤࡷࡩࡸࡺ࡟ࡧ࡫࡯ࡩࡸࠨॕ"): [],
                bstack11l111_opy_ (u"ࠥࡩࡷࡸ࡯ࡳࠤॖ"): bstack11l1ll1l_opy_ (u"ࠦࡈࡵ࡬࡭ࡧࡦࡸ࡮ࡵ࡮ࠡࡧࡵࡶࡴࡸ࠺ࠡࡽࡦࡳࡱࡲࡥࡤࡶࡲࡶ࠳ࡩ࡯࡭࡮ࡨࡧࡹ࡯࡯࡯ࡡࡨࡶࡷࡵࡲࡾࠤॗ")
            }
        return {
            bstack11l111_opy_ (u"ࠧࡹࡵࡤࡥࡨࡷࡸࠨक़"): True,
            bstack11l111_opy_ (u"ࠨࡣࡰࡷࡱࡸࠧख़"): len(collector.bstack11ll1111_opy_),
            bstack11l111_opy_ (u"ࠢ࡯ࡱࡧࡩ࡮ࡪࡳࠣग़"): collector.bstack11ll1111_opy_,
            bstack11l111_opy_ (u"ࠣࡶࡨࡷࡹࡥࡦࡪ࡮ࡨࡷࠧज़"): sorted(collector.test_files),
            bstack11l111_opy_ (u"ࠤࡨࡼ࡮ࡺ࡟ࡤࡱࡧࡩࠧड़"): exit_code
        }
    except Exception as e:
        error_msg = bstack11l1ll1l_opy_ (u"࡙ࠥࡳ࡫ࡸࡱࡧࡦࡸࡪࡪࠠࡦࡴࡵࡳࡷࠦࡩ࡯ࠢࡷࡩࡸࡺࠠࡤࡱ࡯ࡰࡪࡩࡴࡪࡱࡱ࠾ࠥࢁࡳࡵࡴࠫࡩ࠮ࢃࠢढ़")
        return {
            bstack11l111_opy_ (u"ࠦࡸࡻࡣࡤࡧࡶࡷࠧफ़"): False,
            bstack11l111_opy_ (u"ࠧࡩ࡯ࡶࡰࡷࠦय़"): 0,
            bstack11l111_opy_ (u"ࠨ࡮ࡰࡦࡨ࡭ࡩࡹࠢॠ"): [],
            bstack11l111_opy_ (u"ࠢࡵࡧࡶࡸࡤ࡬ࡩ࡭ࡧࡶࠦॡ"): [],
            bstack11l111_opy_ (u"ࠣࡧࡵࡶࡴࡸࠢॢ"): error_msg
        }
def bstack11ll1lll_opy_(cache_dir=bstack11l111_opy_ (u"ࠩ࠱ࡴࡾࡺࡥࡴࡶࡢࡧࡦࡩࡨࡦࠩॣ")):
    bstack11l111_opy_ (u"ࠥࠦࠧࠐࠠࠡࠢࠣࡋࡪࡺࠠࡵࡪࡨࠤࡱ࡯ࡳࡵࠢࡲࡪࠥ࡬ࡡࡪ࡮ࡨࡨࠥࡺࡥࡴࡶࠣࡲࡴࡪࡥࠡࡋࡇࡷࠥࡪࡩࡳࡧࡦࡸࡱࡿࠠࡧࡴࡲࡱࠥࡶࡹࡵࡧࡶࡸࠥࡩࡡࡤࡪࡨ࠲ࠏࠦࠠࠡࠢࡗ࡬࡮ࡹࠠࡪࡵࠣࡪࡦࡹࡴࡦࡴࠣࡸ࡭ࡧ࡮ࠡࡴࡸࡲࡳ࡯࡮ࡨࠢࡦࡳࡱࡲࡥࡤࡶ࡬ࡳࡳࠦࡡ࡯ࡦࠣࡧࡦࡴࠠࡣࡧࠣࡹࡸ࡫ࡤࠡࡶࡲࠤࡶࡻࡩࡤ࡭࡯ࡽࠥࡪࡥࡵࡧࡵࡱ࡮ࡴࡥࠋࠢࠣࠤࠥࡽࡨࡪࡥ࡫ࠤࡹ࡫ࡳࡵࡵࠣࡪࡦ࡯࡬ࡦࡦࠣࡻ࡮ࡺࡨࡰࡷࡷࠤ࡮ࡴࡶࡰ࡭࡬ࡲ࡬ࠦࡰࡺࡶࡨࡷࡹ࠴ࠊࠡࠢࠣࠤࡆࡸࡧࡴ࠼ࠍࠤࠥࠦࠠࠡࠢ