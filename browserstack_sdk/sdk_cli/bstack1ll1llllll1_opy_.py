...
class bstack1ll1ll11l1l_opy_:
    bstack1ll1ll11ll1_opy_ = bstack1lll11l_opy_ (u"ࠢࡣࡧࡱࡧ࡭ࡳࡡࡳ࡭ࠥᇷ")
    context: bstack1lll1l1lll1_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1lll1l1lll1_opy_):
        self.context = context
        self.data = dict({bstack1ll1ll11l1l_opy_.bstack1ll1ll11ll1_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack1lll11l_opy_ (u"ࠨࡄࡕࡓ࡜࡙ࡅࡓࡕࡗࡅࡈࡑ࡟ࡑࡎࡄࡘࡋࡕࡒࡎࡡࡌࡒࡉࡋࡘࠨᇸ"), bstack1lll11l_opy_ (u"ࠩ࠳ࠫᇹ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll11l11_opy_(self, target: object):
        return bstack1ll1ll11l1l_opy_.create_context(target) == self.context
    def bstack1ll1lll1lll_opy_(self, context: bstack1lll1l1lll1_opy_):
