...
class bstack1ll1ll11l1l_opy_:
    bstack1ll1ll111ll_opy_ = bstack1l111ll_opy_ (u"ࠦࡧ࡫࡮ࡤࡪࡰࡥࡷࡱࠢᇻ")
    context: bstack1llll111l1l_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1llll111l1l_opy_):
        self.context = context
        self.data = dict({bstack1ll1ll11l1l_opy_.bstack1ll1ll111ll_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack1l111ll_opy_ (u"ࠬࡈࡒࡐ࡙ࡖࡉࡗ࡙ࡔࡂࡅࡎࡣࡕࡒࡁࡕࡈࡒࡖࡒࡥࡉࡏࡆࡈ࡜ࠬᇼ"), bstack1l111ll_opy_ (u"࠭࠰ࠨᇽ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll11l11_opy_(self, target: object):
        return bstack1ll1ll11l1l_opy_.create_context(target) == self.context
    def bstack1ll1lll1lll_opy_(self, context: bstack1llll111l1l_opy_):
        return context and context.thread_id == self.context.thread_id and context.process_id == self.context.process_id
    def bstack1l111l1l11_opy_(self, key: str, value: timedelta):
        self.data[bstack1ll1ll11l1l_opy_.bstack1ll1ll111ll_opy_][key] += value
    def bstack1ll1ll111l1_opy_(self) -> dict:
        return self.data[bstack1ll1ll11l1l_opy_.bstack1ll1ll111ll_opy_]
    @staticmethod
    def create_context(
        target: object,
