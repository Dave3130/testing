...
class bstack1ll1ll1111l_opy_:
    bstack1ll1ll111l1_opy_ = bstack11l1111_opy_ (u"ࠧࡨࡥ࡯ࡥ࡫ࡱࡦࡸ࡫ࠣሑ")
    context: bstack1llll1111l1_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1llll1111l1_opy_):
        self.context = context
        self.data = dict({bstack1ll1ll1111l_opy_.bstack1ll1ll111l1_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack11l1111_opy_ (u"࠭ࡂࡓࡑ࡚ࡗࡊࡘࡓࡕࡃࡆࡏࡤࡖࡌࡂࡖࡉࡓࡗࡓ࡟ࡊࡐࡇࡉ࡝࠭ሒ"), bstack11l1111_opy_ (u"ࠧ࠱ࠩሓ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll11111_opy_(self, target: object):
        return bstack1ll1ll1111l_opy_.create_context(target) == self.context
    def bstack1ll1lll11l1_opy_(self, context: bstack1llll1111l1_opy_):
        return context and context.thread_id == self.context.thread_id and context.process_id == self.context.process_id
    def bstack1ll1l11l1_opy_(self, key: str, value: timedelta):
        self.data[bstack1ll1ll1111l_opy_.bstack1ll1ll111l1_opy_][key] += value
    def bstack1ll1l1lllll_opy_(self) -> dict:
        return self.data[bstack1ll1ll1111l_opy_.bstack1ll1ll111l1_opy_]
    @staticmethod
    def create_context(
        target: object,
