...
class bstack1lll11lllll_opy_:
    ...
    def __init__(self, timeout=1, bstack1l1ll1ll1ll_opy_=1, bstack1l1ll1lll11_opy_=None, bstack1l1ll1llll1_opy_=None):
    ...
    def enqueue(self, job: Callable):
        if not callable(job):
            raise ValueError(bstack1ll1ll1_opy_ (u"ࠧ࡯࡮ࡷࡣ࡯࡭ࡩࠦࡪࡰࡤ࠽ࠤࠧ዇") + type(job))
        self.queue.put(job)
    def start(self):
        if self.threads:
            return
