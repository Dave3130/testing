...
class bstack1ll1lll1111_opy_:
    bstack1ll1lll111l_opy_ = bstack1ll1ll1_opy_ (u"ࠦࡧ࡫࡮ࡤࡪࡰࡥࡷࡱࠢᇟ")
    context: bstack1lll1l11l11_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1lll1l11l11_opy_):
        self.context = context
        self.data = dict({bstack1ll1lll1111_opy_.bstack1ll1lll111l_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack1ll1ll1_opy_ (u"ࠬࡈࡒࡐ࡙ࡖࡉࡗ࡙ࡔࡂࡅࡎࡣࡕࡒࡁࡕࡈࡒࡖࡒࡥࡉࡏࡆࡈ࡜ࠬᇠ"), bstack1ll1ll1_opy_ (u"࠭࠰ࠨᇡ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll1llll_opy_(self, target: object):
        return bstack1ll1lll1111_opy_.create_context(target) == self.context
    def bstack1lll111l1l1_opy_(self, context: bstack1lll1l11l11_opy_):
    ...
    def bstack1ll1lll11l1_opy_(self) -> dict:
