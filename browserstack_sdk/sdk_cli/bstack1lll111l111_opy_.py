...
class bstack1ll1lll111l_opy_:
    bstack1ll1lll1111_opy_ = bstack1ll1l_opy_ (u"ࠦࡧ࡫࡮ࡤࡪࡰࡥࡷࡱࠢᇘ")
    context: bstack1lll1l1ll1l_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1lll1l1ll1l_opy_):
        self.context = context
        self.data = dict({bstack1ll1lll111l_opy_.bstack1ll1lll1111_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack1ll1l_opy_ (u"ࠬࡈࡒࡐ࡙ࡖࡉࡗ࡙ࡔࡂࡅࡎࡣࡕࡒࡁࡕࡈࡒࡖࡒࡥࡉࡏࡆࡈ࡜ࠬᇙ"), bstack1ll1l_opy_ (u"࠭࠰ࠨᇚ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll1lll1_opy_(self, target: object):
        return bstack1ll1lll111l_opy_.create_context(target) == self.context
    def bstack1lll1111111_opy_(self, context: bstack1lll1l1ll1l_opy_):
        return context and context.thread_id == self.context.thread_id and context.process_id == self.context.process_id
    def bstack111111l1l_opy_(self, key: str, value: timedelta):
        self.data[bstack1ll1lll111l_opy_.bstack1ll1lll1111_opy_][key] += value
    def bstack1ll1ll1llll_opy_(self) -> dict:
        return self.data[bstack1ll1lll111l_opy_.bstack1ll1lll1111_opy_]
    @staticmethod
    def create_context(
        target: object,
