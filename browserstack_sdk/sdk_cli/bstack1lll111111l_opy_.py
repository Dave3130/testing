...
class bstack1ll1lll11l1_opy_:
    bstack1ll1lll1111_opy_ = bstack1ll11_opy_ (u"ࠤࡥࡩࡳࡩࡨ࡮ࡣࡵ࡯ࠧᇝ")
    context: bstack1llll11l111_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1llll11l111_opy_):
        self.context = context
        self.data = dict({bstack1ll1lll11l1_opy_.bstack1ll1lll1111_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack1ll11_opy_ (u"ࠪࡆࡗࡕࡗࡔࡇࡕࡗ࡙ࡇࡃࡌࡡࡓࡐࡆ࡚ࡆࡐࡔࡐࡣࡎࡔࡄࡆ࡚ࠪᇞ"), bstack1ll11_opy_ (u"ࠫ࠵࠭ᇟ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll1llll_opy_(self, target: object):
        return bstack1ll1lll11l1_opy_.create_context(target) == self.context
    def bstack1lll111l111_opy_(self, context: bstack1llll11l111_opy_):
        return context and context.thread_id == self.context.thread_id and context.process_id == self.context.process_id
    def bstack1111l11l11_opy_(self, key: str, value: timedelta):
        self.data[bstack1ll1lll11l1_opy_.bstack1ll1lll1111_opy_][key] += value
    def bstack1ll1lll111l_opy_(self) -> dict:
        return self.data[bstack1ll1lll11l1_opy_.bstack1ll1lll1111_opy_]
    @staticmethod
    def create_context(
        target: object,
