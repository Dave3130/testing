...
class bstack1lll11ll111_opy_:
    ...
    bstack1l1ll1l11ll_opy_: Union[None, Callable]
    def __init__(self, timeout=1, bstack1l1ll1l1l1l_opy_=1, bstack1l1ll1l11l1_opy_=None, bstack1l1ll1l11ll_opy_=None):
    ...
    def enqueue(self, job: Callable):
        if not callable(job):
            raise ValueError(bstack1l1_opy_ (u"ࠦ࡮ࡴࡶࡢ࡮࡬ࡨࠥࡰ࡯ࡣ࠼ࠣࠦዛ") + type(job))
        self.queue.put(job)
    def start(self):
        if self.threads:
            return
        self.threads = [threading.Thread(target=self.worker, daemon=True) for _ in range(self.bstack1l1ll1l1l1l_opy_)]
    ...
    def stop(self):
        ...
        self.threads.clear()
    def worker(self):
        while not self.bstack1l1ll1l1l11_opy_.is_set():
            try:
                ...
                if callable(self.bstack1l1ll1l11ll_opy_):
                    self.bstack1l1ll1l11ll_opy_(e)