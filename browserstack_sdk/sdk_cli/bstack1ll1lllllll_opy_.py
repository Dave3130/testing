...
class bstack1ll1ll11ll1_opy_:
    bstack1ll1ll11lll_opy_ = bstack11l111_opy_ (u"ࠤࡥࡩࡳࡩࡨ࡮ࡣࡵ࡯ࠧሀ")
    context: bstack1lll1lllll1_opy_
    data: Dict[str, Any]
    platform_index: int
    def __init__(self, context: bstack1lll1lllll1_opy_):
        self.context = context
        self.data = dict({bstack1ll1ll11ll1_opy_.bstack1ll1ll11lll_opy_: defaultdict(lambda: timedelta(microseconds=0))})
        self.platform_index = int(os.environ.get(bstack11l111_opy_ (u"ࠪࡆࡗࡕࡗࡔࡇࡕࡗ࡙ࡇࡃࡌࡡࡓࡐࡆ࡚ࡆࡐࡔࡐࡣࡎࡔࡄࡆ࡚ࠪሁ"), bstack11l111_opy_ (u"ࠫ࠵࠭ሂ")))
    def ref(self) -> str:
        return str(self.context.id)
    def bstack1ll1ll11l11_opy_(self, target: object):
        return bstack1ll1ll11ll1_opy_.create_context(target) == self.context
    def bstack1ll1llll1ll_opy_(self, context: bstack1lll1lllll1_opy_):
